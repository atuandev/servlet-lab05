	...
	<div class="container">
		...
		<form action="dien-thoai?action=insert" method="post" enctype="multipart/form-data"
			...
			<table class="table">
				...
				<tr>
					<th>Tên</th>
					<td><input type="text" name="tenDT" class="w-full border p-2"></td>
				</tr>
				<tr>
					<th>Năm sản xuất</th>
					<td><input type="number" maxlength="4" name="namSanXuat" class="w-full border p-2"></td>
				</tr>
				<tr>
					<th>Cấu hình</th>
					<td><input type="text" name="cauHinh" class="w-full border p-2"></td>
				</tr>
				<tr>
					<th>Hình ảnh</th>
					<td><input type="file" name="hinhAnh" class="w-full border p-2" ></td>
				</tr>
